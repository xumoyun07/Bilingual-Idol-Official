...
export const translations: Record<Language, TranslationDictionary> = {
  en: {
    ...
    login: {
      ...
      emailLabel: "Login",
      emailPlaceholder: "nickname@bilc.my",
      ...
      helpText: "Sign in using your assigned nickname@bilc.my credentials and password. Contact admissions if you need your account details.",
    },
    userDashboard: {
      welcome: "Welcome",
  ...
  ms: {
    ...
    login: {
      ...
      helpText: "Log masuk menggunakan akaun nickname@bilc.my dan kata laluan anda. Hubungi bahagian kemasukan jika anda memerlukan maklumat akaun.",
    },
    userDashboard: {
  ...
  ar: {
    ...
    login: {
      ...
      helpText: "سجّل الدخول باستخدام حسابك nickname@bilc.my وكلمة المرور. تواصل مع إدارة المركز إذا احتجت إلى بيانات الدخول.",
    },
    userDashboard: {
      welcome: "أهلاً بك",
  ...
  ru: {
    nav: {
      home: "Главная",
      about: "О центре",
      programs: "Программы и Цены",
      news: "Новости и События",
      contact: "Контакты",
      makeEnquiry: "Задать вопрос",
      signIn: "Войти",
      signOut: "Выйти",
      ...
      enrollNow: "Подать заявку",
      bookTour: "Записаться на визит",
    },
    footer: {
      centreName: "Языковой центр Bilingual Idol",
      location: "Pavilion Embassy, Jalan Ampang, Куала-Лумпур",
      brandSubtitle: "Премиальное билингвальное и международное языковое образование для детей, подростков и взрослых.",
    ...
    common: {
      ...
      thankYou: "Спасибо!",
      close: "Закрыть",
      requiredFields: "Поля со звездочкой (*) обязательны для заполнения.",
      viewProgrammes: "Все программы",
      cancel: "Отмена",
      next: "Далее",
      prev: "Назад",
      step: "Шаг",
      ...
      addressText: "Suite 12-01, Pavilion Embassy, Jalan Ampang, 50450 Kuala Lumpur",
    },
    home: {
      eyebrow: "Официальный языковой центр в Pavilion Embassy",
      heroTitle: "Откройте уверенное двуязычие и глобальное лидерство",
      heroSubtitle: "Персонализированные курсы английского и мировых языков по шкале CEFR для детей, подготовки к IELTS и корпоративного роста.",
      ctaFindCourse: "Подобрать курс",
      ctaEnquiry: "Бесплатная консультация",
      ctaPlacement: "Тест уровня (3 мин)",
      ctaBooking: "Записаться на визит",
      taskPlacementTitle: "Онлайн-тест CEFR",
      taskPlacementDesc: "Определите ваш текущий уровень английского за 3 минуты с персональными рекомендациями.",
      taskConsultationTitle: "Академическая консультация",
      taskConsultationDesc: "Встреча с методистом центра в Pavilion Embassy для построения индивидуального трека.",
      taskProgramsTitle: "Каталог курсов 2026",
      taskProgramsDesc: "Ознакомьтесь со структурой уровней A1–C2, расписанием и официальным прейскурантом.",
      taskContactTitle: "Связаться с отделом заботы",
      taskContactDesc: "Прямой диалог через WhatsApp или телефонную линию с кураторами учебного процесса.",
      pricingEyebrow: "Прозрачная стоимость обучения 2026",
      pricingTitle: "Официальный прейскурант и структура пакетов",
      pricingSubtitle: "Все программы включают международные учебные материалы, доступ к платформе и сертификат CEFR.",
      pricingTabGeneral: "Общий английский",
      pricingTabIelts: "Подготовка к IELTS",
      pricingTabCamps: "Каникулярные лагеря",
      pricingTabPrivate: "Индивидуально 1-на-1",
      pricingTabExecutive: "Деловой английский",
      pricingTabWorld: "Мировые языки",
      startHereEyebrow: "Быстрый старт",
      startHereTitle: "Как начать обучение в Bilingual Idol",
      startHereDesc: "Четыре простых шага от первого тестирования до получения международного сертификата.",
      admissionsTag: "Прием открыт",
      taskPortalTitle: "Студенческий портал",
      taskPortalDesc: "Личный кабинет с оценками, расписанием и комментариями преподавателей.",
      facilitiesEyebrow: "Кампус премиум-класса",
      facilitiesTitle: "Современное образовательное пространство",
      facilitiesSubtitle: "Интерактивные аудитории, студии произношения и ресурсные центры в самом сердце столицы.",
      journeyEyebrow: "Образовательный маршрут",
      journeyTitle: "Траектория академического роста",
      journeySubtitle: "Пошаговое освоение уровней от A1 до C2 с непрерывным мониторингом успеваемости.",
      testimonialsEyebrow: "Отзывы наших студентов",
      testimonialsTitle: "Истории успеха и реальные результаты",
      testimonialsSubtitle: "Более 480 активных учеников и семей доверяют академическому качеству BILC.",
      contactStripTitle: "Готовы сделать первый шаг к свободному языку?",
      contactStripSubtitle: "Запишитесь на бесплатное пробное занятие и персональную консультацию сегодня.",
      contactStripButton: "Подать заявку сейчас",
      languageBandTitle: "Многоязычная образовательная среда",
      languageBandSubtitle: "Обучение с носителями языка и международными методистами высшей квалификации.",
    },
    about: {
      eyebrow: "Наша миссия и принципы",
      heroTitle: "Воспитываем лидеров глобального билингвального мира",
      heroSubtitle: "Сочетаем академическую строгость кембриджских стандартов с иммерсивным разговорным погружением.",
      storyEyebrow: "История создания",
      storyTitle: "От языкового клуба к ведущему центру столицы",
      storyBody: "Центр Bilingual Idol основан для создания премиальной образовательной среды, где изучение языка становится естественным и увлекательным процессом.",
      explorePrograms: "Смотреть программы",
      approachEyebrow: "Методика обучения",
      approachTitle: "Научный и коммуникативный подход",
      approachSubtitle: "Сбалансированное развитие 4 ключевых языковых навыков с первых дней.",
      approach1Title: "Полное погружение",
      approach1Body: "Занятия ведутся исключительно на целевом языке с использованием интерактивных мультимедиа.",
      approach2Title: "Шкала CEFR",
      approach2Body: "Четкая система уровней от A1 до C2 с регулярной независимой аттестацией.",
      approach3Title: "Малые группы",
      approach3Body: "До 8 человек в группе для максимального персонального внимания каждому ученику.",
      communityEyebrow: "Сообщество",
      communityTitle: "Больше, чем просто языковая школа",
      communityCaption: "Клуб дебатов, разговорные встречи и культурные мероприятия каждую неделю.",
      teamEyebrow: "Преподаватели",
      teamTitle: "Сертифицированные педагоги-носители",
      teamSubtitle: "Преподаватели с дипломами CELTA, DELTA и многолетним международным стажем.",
    },
    programs: {
      eyebrow: "Учебные направления",
      heroTitle: "Языковые программы для любых целей и возрастов",
      heroSubtitle: "Выберите подходящий курс: от раннего развития до профессиональной подготовки к IELTS и бизнесу.",
      guideEyebrow: "Навигация по уровням",
      guideTitle: "Шкала уровней CEFR",
      guideSubtitle: "Понятная система оценки языковой компетенции.",
      feeGuideEyebrow: "Стоимость",
      feeGuideTitle: "Тарифные планы 2026 года",
      feeGuideSubtitle: "Гибкие варианты оплаты: помесячно, посеместрово или за полный курс со скидкой.",
      searchPlaceholder: "Поиск программы по названию, уровню или возрасту...",
      filterLabel: "Категория:",
      filterAll: "Все программы",
      countShown: "Показано программ:",
      showingCount: "Найдено {count} направлений",
      noMatches: "Программы не найдены",
      emptyText: "Попробуйте изменить параметры поиска или фильтрации.",
      emptyCta: "Сбросить фильтры",
      viewDetails: "Подробнее о курсе",
      catAll: "Все",
      catKids: "Дети и подростки",
      catEnglish: "Английский для взрослых",
      catWorldLanguages: "Мировые языки",
      catProfessional: "Бизнес и IELTS",
    },
    programDetail: {
      backLink: "Назад ко всем программам",
      overviewEyebrow: "Обзор курса",
      duration: "Продолжительность",
      schedule: "Расписание",
      fees: "Стоимость",
      level: "Уровень CEFR",
      ageGroup: "Возрастная группа",
      outcomesTitle: "Чему вы научитесь на курсе",
      ctaTitle: "Готовы присоединиться к группе?",
      ctaSubtitle: "Оставьте заявку, и мы забронируем за вами место со скидкой раннего бронирования.",
      ctaButton: "Записаться на этот курс",
    },
    contact: {
      eyebrow: "Связь с центром",
      heroTitle: "Мы всегда рады вашим вопросам и визитам",
      heroSubtitle: "Наш центр расположен в Pavilion Embassy на Jalan Ampang в Куала-Лумпуре.",
      call: "Телефон приемной",
      whatsapp: "WhatsApp-линия",
      whatsappValue: "+60 12-345 6789",
      email: "Электронная почта",
      hours: "График работы",
      openingHours: "Пн-Пт: 8:30 – 20:30 | Сб-Вс: 9:00 – 18:00",
      address: "Адрес центра",
      addressText: "Suite 12-01, Pavilion Embassy, Jalan Ampang, 50450 Kuala Lumpur",
      formEyebrow: "Напишите нам",
      formTitle: "Форма обратной связи",
      formSubtitle: "Заполните форму, и дежурный консультант свяжется с вами в течение 15 минут.",
      formCardTitle: "Отправить запрос",
      submitButton: "Отправить заявку",
    },
    enroll: {
      backLink: "Назад",
      eyebrow: "Официальная регистрация",
      heroTitle: "Заявление на зачисление в центр",
      heroSubtitle: "Заполните регистрационную анкету для подбора группы и оформления договора.",
      nextStepsTitle: "Дальнейшие шаги:",
      step1: "1. Проверка анкеты методистом (15 минут)",
      step2: "2. Бесплатное устное тестирование уровня",
      step3: "3. Выбор расписания и старт занятий",
      formEyebrow: "Анкета абитуриента",
      formTitle: "Данные студента и законного представителя",
      formSubtitle: "Все данные защищены и обрабатываются в строгом соответствии с политикой конфиденциальности.",
      studentNameLabel: "ФИО студента *",
      studentNamePlaceholder: "Например: Иванов Даниил",
      studentAgeLabel: "Возраст студента *",
      studentAgePlaceholder: "Например: 14",
      programLabel: "Выбранная программа *",
      programPlaceholder: "Выберите направление...",
      scheduleLabel: "Предпочтительное расписание *",
      schedulePlaceholder: "Выберите время занятий...",
      parentNameLabel: "ФИО родителя / опекуна *",
      parentNamePlaceholder: "Например: Иванова Елена",
      emailLabel: "Электронная почта *",
      emailPlaceholder: "email@example.com",
      phoneLabel: "Номер телефона (с кодом) *",
      phonePlaceholder: "+7 999 123 45 67",
      messageLabel: "Дополнительные пожелания",
      messagePlaceholder: "Предыдущий опыт изучения, цели, пожелания по графику...",
      submitButton: "Отправить заявление на зачисление",
      requiredNote: "* Поля, обязательные для заполнения",
      successTitle: "Заявление успешно зарегистрировано!",
      successSubtitle: "Мы отправили подтверждение на вашу почту и свяжемся с вами в ближайшее время.",
      submitAnother: "Заполнить еще одно заявление",
    },
    news: {
      eyebrow: "Жизнь центра",
      heroTitle: "Новости, события и академические обновления",
      heroSubtitle: "Будьте в курсе наборов в новые группы, мастер-классов и достижений наших студентов.",
      searchPlaceholder: "Поиск новостей и статей...",
      allCategories: "Все категории",
      readMore: "Читать полностью",
      readUpdate: "Подробнее",
      previous: "Предыдущая",
      next: "Следующая",
      noUpdates: "Новостей пока нет",
      noUpdatesText: "Следите за обновлениями, новые материалы публикуются еженедельно.",
    },
    login: {
      eyebrow: "Авторизация в системе",
      heroTitle: "Вход в единую экосистему BILC",
      heroSubtitle: "Введите ваш логин (nickname@bilc.my) и пароль для доступа к личному кабинету.",
      emailLabel: "Логин / Никнейм BILC *",
      emailPlaceholder: "teacher@bilc.my или nickname",
      ...
      helpTitle: "Нужна помощь со входом?",
      helpText: "Обратитесь к администратору центра или воспользуйтесь службой поддержки.",
    },
    userDashboard: {
      welcome: "Добро пожаловать",
      roleStudent: "Аккаунт студента",
      roleTeacher: "Аккаунт преподавателя",
      roleMember: "Аккаунт пользователя",
      subtitle: "Ваш профиль активен. Дополнительные данные по вашим курсам отобразятся здесь по мере их публикации администрацией.",
      nextStepTitle: "Подобрать учебную программу",
      nextStepText: "Ознакомьтесь с актуальными направлениями или обратитесь к академическому консультанту для подбора лучшего трека.",
      nextStepButton: "Каталог программ",
      attendanceTitle: "Журнал посещаемости",
      attendanceLoading: "Журнал посещаемости: загрузка...",
      attendanceLoadingText: "Формирование сводки посещаемости за текущий период.",
      attendanceScore: "Посещаемость: {percentage}%",
      attendanceScoreText: "Посещено {attended} из {total} проведенных занятий. Учитываются своевременные явки и уважительные причины.",
      attendanceNotAvailable: "Данные посещаемости пока не внесены.",
      attendanceNotAvailableText: "Статистика появится автоматически после фиксации первых занятий преподавателем.",
      signOut: "Выйти из системы",
      preparing: "Подготовка рабочего пространства",
      preparingText: "Пожалуйста, подождите, пока проверяются права доступа.",
    },
    form: {
      studentName: "ФИО студента *",
      studentNamePlaceholder: "Например: Смирнов Артем",
      studentAge: "Возраст студента *",
      studentAgePlaceholder: "Например: 12",
      parentName: "ФИО родителя / опекуна *",
      parentNamePlaceholder: "Например: Смирнова Ольга",
      parentEmail: "Электронная почта *",
      parentEmailPlaceholder: "name@example.com",
      parentPhone: "Телефон для связи *",
      parentPhonePlaceholder: "+7 999 123 45 67",
      programInterest: "Интересующая программа *",
      selectProgram: "Выберите программу...",
      preferredSchedule: "Удобное время занятий *",
      selectSchedule: "Выберите время...",
      weekdayMorning: "Будни, утренние часы (9:00 - 12:00)",
      weekdayAfternoon: "Будни, дневные часы (14:00 - 17:00)",
      weekdayEvening: "Будни, вечерние часы (18:30 - 21:00)",
      weekendIntensive: "Интенсив выходного дня (Сб и Вс)",
      flexiblePrivate: "Индивидуальный график 1-на-1",
      message: "Цели и пожелания",
      messagePlaceholder: "Расскажите о текущем уровне, целях и сроках подготовки...",
      submitEnquiry: "Отправить запрос",
      sending: "Отправка...",
      successTitle: "Спасибо — ваш запрос принят!",
      successText: "Наш специалист свяжется с вами в течение 15 минут для консультации.",
      submitAnother: "Отправить еще один запрос",
      kicker: "Связаться с нами",
      stepInfo: "Данные студента",
      stepTrack: "Выбор программы",
      stepContact: "Контакты",
    },
    placementModal: {
      title: "Бесплатный онлайн-тест уровня английского (3 минуты)",
      subtitle: "Ответьте на 8 вопросов для определения уровня по шкале CEFR и получения персональных рекомендаций.",
      questionNumber: "Вопрос {current} из {total}",
      completeBtn: "Показать мой уровень и курс",
      resultTitle: "Результаты тестирования",
      yourLevel: "Ваш расчетный уровень (CEFR)",
      diagnosticScore: "Диагностический балл: {score}/8 ({pct}%)",
      recommendedCourse: "Рекомендуемый курс:",
      enrollWithScore: "Записаться на этот уровень",
      retake: "Пройти тест заново",
    },
    bookingModal: {
      title: "Запись на консультацию и очное тестирование в центре",
      subtitle: "Встреча с методистом в Pavilion Embassy, Куала-Лумпур для составления индивидуальной программы.",
      selectDate: "Выберите дату визита *",
      selectTime: "Выберите удобное время *",
      consultationReason: "Цель консультации *",
      bookBtn: "Подтвердить запись на визит",
      successTitle: "Запись успешно подтверждена!",
      successDesc: "Мы забронировали для вас время и отправили детали встречи на указанный контакт.",
    },
    chat: {
      widgetTitle: "Консультант приемной комиссии",
      welcome: "Здравствуйте! Добро пожаловать в языковой центр Bilingual Idol в Pavilion Embassy. Чем я могу помочь вам сегодня?",
      placeholder: "Задайте вопрос о курсах, ценах, IELTS или расписании...",
      send: "Отправить",
    },
  },
};

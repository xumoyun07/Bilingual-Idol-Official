...
export const translations: Record<Language, TranslationDictionary> = {
  en: {
    ...
    programDetail: {
      ...
      ctaSubtitle: "Register your interest to check current availability and discuss your placement.",
      ctaButton: "Apply Now",
    },
    contact: {
      eyebrow: "Contact",
    ...
    enroll: {
      ...
      eyebrow: "Programme Registration",
      heroTitle: "Register for your programme.",
      heroSubtitle: "Complete the official registration form to begin your learning journey.",
      nextStepsTitle: "Your registration process",
      step1: "Submit this registration form with your preferred programme.",
      step2: "Our admissions team will process your details and confirm class schedules.",
      step3: "Your student portal account will be activated, and course materials will be provided.",
  ...
  ms: {
    ...
    programDetail: {
      ...
      ctaSubtitle: "Daftar minat anda untuk menyemak ketersediaan terkini dan membincangkan penempatan anda.",
    ...
    enroll: {
      ...
      eyebrow: "Pendaftaran Program",
      heroTitle: "Daftar untuk program anda.",
      heroSubtitle: "Lengkapkan borang pendaftaran rasmi untuk memulakan perjalanan pembelajaran anda.",
      nextStepsTitle: "Proses pendaftaran anda",
      step1: "Hantar borang pendaftaran ini dengan program pilihan anda.",
      step2: "Pasukan kemasukan kami akan memproses butiran anda dan mengesahkan jadual kelas.",
      step3: "Akaun portal pelajar anda akan diaktifkan, dan bahan kursus akan disediakan.",
  ...
  ar: {
    ...
    programDetail: {
      ...
      ctaSubtitle: "سجل اهتمامك الآن للتحقق من المواعيد المتاحة ومناقشة تفاصيل الالتحاق.",
      ctaButton: "سجل الآن",
    },
    contact: {
      eyebrow: "اتصل بنا",
    ...
    enroll: {
      ...
      eyebrow: "تسجيل البرامج الدراسية",
      heroTitle: "سجل في برنامجك الدراسي.",
      heroSubtitle: "أكمل نموذج التسجيل الرسمي لبدء رحلتك التعليمية.",
      nextStepsTitle: "خطوات عملية التسجيل",
      step1: "أرسل نموذج التسجيل هذا مع تحديد برنامجك المفضل.",
      step2: "سيقوم فريق القبول لدينا بمراجعة بياناتك وتأكيد مواعيد المحاضرات.",
      step3: "سيتم تفعيل حسابك على بوابة الطلاب وتوفير المناهج الدراسية.",

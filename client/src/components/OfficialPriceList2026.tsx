...
const GENERAL_COURSES: GeneralCourse[] = [
  {
    duration: { en: "1 Month", ms: "1 Bulan", ar: "شهر واحد", ru: "1 месяц" },
    rawDuration: "1 Month",
    classes: { en: "5 Days / Week", ms: "5 Hari / Minggu", ar: "5 أيام / أسبوعياً", ru: "5 дней / неделю" },
    visaFee: { en: "—", ms: "—", ar: "—", ru: "—" },
    tuitionFee: "RM 2,950",
  },
  {
    duration: { en: "3 Months", ms: "3 Bulan", ar: "3 أشهر", ru: "3 месяца" },
    rawDuration: "3 Months",
    classes: { en: "5 Days / Week", ms: "5 Hari / Minggu", ar: "5 أيام / أسبوعياً", ru: "5 дней / неделю" },
    visaFee: { en: "RM 3,000", ms: "RM 3,000", ar: "3,000 رنجت", ru: "RM 3,000" },
    tuitionFee: "RM 7,900",
  },
  {
    duration: { en: "6 Months", ms: "6 Bulan", ar: "6 أشهر", ru: "6 месяцев" },
  ...
  {
    duration: { en: "9 Months", ms: "9 Bulan", ar: "9 أشهر", ru: "9 месяцев" },
    rawDuration: "9 Months",
    classes: { en: "5 Days / Week", ms: "5 Hari / Minggu", ar: "5 أيام / أسبوعياً", ru: "5 дней / неделю" },
    visaFee: { en: "RM 4,500", ms: "RM 4,500", ar: "4,500 رنجت", ru: "RM 4,500" },
    tuitionFee: "RM 19,150",
  },
  {
    duration: { en: "12 Months", ms: "12 Bulan", ar: "12 شهراً", ru: "12 месяцев" },
...
const IELTS_COURSES: IeltsCourse[] = [
  {
    name: { en: "IELTS Express", ms: "IELTS Ekspres", ar: "آيلتس السريع (Express)", ru: "IELTS Экспресс" },
    rawName: "IELTS Express",
    duration: { en: "4 Weeks", ms: "4 Minggu", ar: "4 أسابيع", ru: "4 недели" },
    hours: { en: "40 Hours", ms: "40 Jam", ar: "40 ساعة تدريبية", ru: "40 часов" },
    tuitionFee: "RM 3,500",
  },
  {
    name: { en: "IELTS Intensive", ms: "IELTS Intensif", ar: "آيلتس المكثف (Intensive)", ru: "IELTS Интенсив" },
    rawName: "IELTS Intensive",
    duration: { en: "8 Weeks", ms: "8 Minggu", ar: "8 أسابيع", ru: "8 недель" },
    hours: { en: "80 Hours", ms: "80 Jam", ar: "80 ساعة تدريبية", ru: "80 часов" },
    tuitionFee: "RM 6,700",
  },
  {
    name: { en: "IELTS Premium Coaching", ms: "Bimbingan Premium IELTS", ar: "برنامج الآيلتس المتميز (Premium)", ru: "IELTS Премиум-наставничество" },
    rawName: "IELTS Premium Coaching",
    duration: { en: "12 Weeks", ms: "12 Minggu", ar: "12 أسبوعاً", ru: "12 недель" },
    hours: { en: "120 Hours", ms: "120 Jam", ar: "120 ساعة تدريبية", ru: "120 часов" },
    tuitionFee: "RM 9,900",
  },
];
...
const CAMP_COURSES: CampCourse[] = [
  {
    name: { en: "Junior English Summer Camp", ms: "Kem Musim Panas Bahasa Inggeris Junior", ar: "مخيم الصيف للناشئين", ru: "Летний лагерь английского для детей" },
    rawName: "Junior English Summer Camp",
    duration: { en: "2 Weeks", ms: "2 Minggu", ar: "أسبوعان", ru: "2 недели" },
    tuitionFee: "RM 4,400",
    highlight: {
      ...
      ru: "Для возраста 7–14 лет, интерактивные занятия и экскурсии по KL",
    },
  },
  {
    name: { en: "International Summer Camp", ms: "Kem Musim Panas Antarabangsa", ar: "المخيم الصيفي الدولي", ru: "Международный летний лагерь" },
    ...
    highlight: {
      ...
      ru: "Интернациональный состав, языковая практика и академическая подготовка",
    },
  },
  {
    name: { en: "Premium Leadership & English Camp", ms: "Kem Kepimpinan & Bahasa Inggeris Premium", ar: "مخيم القيادة واللغة المتميز", ru: "Премиум-лагерь лидерства и английского" },
    ...
    highlight: {
      ...
      ru: "Модули лидерства, публичные выступления и поездки по достопримечательностям",
    },
  },
];
...
const PRIVATE_COURSES: PrivateCourse[] = [
  {
    package: { en: "Silver Package", ms: "Pakej Perak (Silver)", ar: "الباقة الفضية (Silver)", ru: "Пакет Silver" },
    rawPackage: "Silver Package",
    hours: { en: "10 Hours", ms: "10 Jam", ar: "10 ساعات", ru: "10 часов" },
    tuitionFee: "RM 1,800",
  },
  {
    package: { en: "Gold Package", ms: "Pakej Emas (Gold)", ar: "الباقة الذهبية (Gold)", ru: "Пакет Gold" },
    rawPackage: "Gold Package",
    hours: { en: "20 Hours", ms: "20 Jam", ar: "20 ساعة", ru: "20 часов" },
    tuitionFee: "RM 3,200",
  },
  {
    package: { en: "Platinum Package", ms: "Pakej Platinum", ar: "الباقة البلاتينية (Platinum)", ru: "Пакет Platinum" },
    rawPackage: "Platinum Package",
    hours: { en: "40 Hours", ms: "40 Jam", ar: "40 ساعة", ru: "40 часов" },
    tuitionFee: "RM 5,800",
  },
];
...
const EXECUTIVE_COURSES: ExecutiveCourse[] = [
  {
    programme: { en: "Business English", ms: "Bahasa Inggeris Perniagaan", ar: "الإنجليزية للأعمال (Business English)", ru: "Деловой английский" },
    rawProgramme: "Business English",
    duration: { en: "1 Month", ms: "1 Bulan", ar: "شهر واحد", ru: "1 месяц" },
    tuitionFee: { en: "RM 3,800", ms: "RM 3,800", ar: "3,800 رنجت", ru: "RM 3,800" },
    desc: {
      ...
      ru: "Бизнес-презентации, деловая переписка и свободное ведение переговоров",
    },
  },
  {
    programme: { en: "Executive Communication", ms: "Komunikasi Eksekutif", ar: "التواصل التنفيذي والدبلوماسي", ru: "Исполнительные коммуникации" },
    rawProgramme: "Executive Communication",
    duration: { en: "2 Months", ms: "2 Bulan", ar: "شهران", ru: "2 месяца" },
    tuitionFee: { en: "RM 6,600", ms: "RM 6,600", ar: "6,600 رنجت", ru: "RM 6,600" },
    desc: {
      ...
      ru: "Переговоры на высшем уровне, деловой этикет и дипломатия",
    },
  },
  {
    programme: { en: "Corporate English Masterclass", ms: "Masterclass Bahasa Inggeris Korporat", ar: "ماستركلاس الشركات والمؤسسات", ru: "Корпоративный мастер-класс" },
    rawProgramme: "Corporate English Masterclass",
    duration: { en: "Customised", ms: "Tersuai", ar: "حسب الطلب", ru: "По запросу" },
    tuitionFee: { en: "Upon Request", ms: "Atas Permintaan", ar: "حسب الطلب", ru: "По запросу" },
    desc: {
      ...
      ru: "Специализированные программы для команд международных корпораций и дипмиссий",
    },
  },
];
...
const WORLD_LANGUAGES = [
  {
    code: "EN",
    name: { en: "English", ms: "Bahasa Inggeris", ar: "اللغة الإنجليزية", ru: "Английский язык" },
    rawName: "English",
    native: "English",
    desc: {
      ...
      ru: "Общий, академический, подготовка к IELTS и бизнес-программы",
    },
  },
  {
    code: "ZH",
    name: { en: "Mandarin", ms: "Bahasa Mandarin", ar: "اللغة الصينية (ماندرين)", ru: "Китайский язык (Мандарин)" },
    rawName: "Mandarin",
    native: "普通话 / 中文",
    desc: {
      ...
      ru: "Подготовка к HSK, деловой китайский и разговорная практика",
    },
  },
  {
    code: "MS",
    name: { en: "Malay", ms: "Bahasa Melayu", ar: "اللغة الملايوية", ru: "Малайский язык" },
    rawName: "Malay",
    ...
    desc: {
      ...
      ru: "Базовый и продвинутый язык для комфортной жизни и работы в Малайзии",
    },
  },
  {
    code: "AR",
    name: { en: "Arabic", ms: "Bahasa Arab", ar: "اللغة العربية", ru: "Арабский язык" },
    rawName: "Arabic",
    native: "العربية",
    desc: {
      ...
      ru: "Современный литературный арабский для дипломатии, бизнеса и учебы",
    },
  },
  {
    code: "KO",
    name: { en: "Korean", ms: "Bahasa Korea", ar: "اللغة الكورية", ru: "Корейский язык" },
    rawName: "Korean",
    native: "한국어",
    desc: {
      ...
      ru: "Подготовка к TOPIK, современный разговорный корейский язык",
    },
  },
  {
    code: "JA",
    name: { en: "Japanese", ms: "Bahasa Jepun", ar: "اللغة اليابانية", ru: "Японский язык" },
    rawName: "Japanese",
    native: "日本語",
    desc: {
      ...
      ru: "Подготовка к JLPT, деловой японский и этикет",
    },
  },
];

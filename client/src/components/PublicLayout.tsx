  ...
  return <div className="simple-public-shell">
    ...
    <header className="simple-public-header simple-public-header--refined">
      <div className="simple-public-bar">
        ...
        <div className="simple-public-actions"><a className="simple-contact-link simple-contact-link--green" href="tel:+60367310449"><Phone size={16} aria-hidden="true" /> Call</a><Link href="/login" className="simple-button simple-button-quiet">Sign in</Link><Link href="/enroll" className="simple-button">Make an enquiry</Link></div>

...
export default function Home() {
  ...
  return <PublicLayout><div className="simple-public-page">
    <section className="simple-home-intro"><div><p className="simple-eyebrow">Language learning in Setapak</p><h1>Find the right next step for learning.</h1><p>Explore language programmes, ask the centre a question, or sign in to the information prepared for your account.</p><div className="simple-actions-row"><Link href="/programs" className="simple-button">View programmes <ArrowRight size={17} /></Link><Link href="/contact" className="simple-button simple-button-quiet">Contact the centre</Link></div></div></section>

    <section className="simple-section"><div className="simple-section-heading"><div><p className="simple-eyebrow">Start here</p><h2>What do you need today?</h2></div><p>Choose one clear action. You can ask for help before choosing a programme.</p></div><div className="simple-task-grid"><Link href="/programs" className="simple-task-card"><BookOpen size={22} /><div><h3>Browse programmes</h3><p>Filter confirmed options by language, learner group and level.</p></div><ArrowRight size={18} /></Link><Link href="/contact" className="simple-task-card"><MessageCircle size={22} /><div><h3>Ask a question</h3><p>Call, email, WhatsApp or send an enquiry to the centre.</p></div><ArrowRight size={18} /></Link><Link href="/login" className="simple-task-card"><UserRound size={22} /><div><h3>Access your account</h3><p>Sign in with the details issued by the centre.</p></div><ArrowRight size={18} /></Link></div></section>

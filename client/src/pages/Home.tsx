...
export default function Home() {
  ...
  return <PublicLayout><div className="simple-public-page">
    <section className="simple-home-intro simple-home-intro-media simple-home-intro-offset simple-home-intro--refined simple-home-intro--desktop-geometry simple-home-intro--mobile-480 simple-home-intro--desktop-450">
      ...
      <div className="simple-home-intro-content simple-home-intro-content--desktop-offset"><p className="simple-eyebrow">Language learning in Setapak</p><h1>Find the right next step for learning.</h1><p>Explore language programmes, ask the centre a question, or sign in to the information prepared for your account.</p><div className="simple-actions-row"><Link href="/programs" className="simple-button">View programmes <ArrowRight size={17} /></Link><Link href="/contact" className="simple-button simple-button-quiet">Contact the centre</Link></div></div>
    </section>

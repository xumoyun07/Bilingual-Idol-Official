...
export default function Home() {
  ...
  return <PublicLayout><div className="simple-public-page">
    <section className="simple-home-intro simple-home-intro-media simple-home-intro-offset simple-home-intro--refined simple-home-intro--desktop-geometry simple-home-intro--mobile-480">
